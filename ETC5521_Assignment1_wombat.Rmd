...
Figure \@ref(fig:missing-vals-check) shows that there is no missing value in the dataset. It is inline with what @AntonioNuno2019Hbdd stated that there is no missing values in the database table. However, some "NULL" values are presented which should be interpreted as "not applicable", not a missing value [@AntonioNuno2019Hbdd].
